...
export default function AboutPage() {
  return (
    ...
    >
      ...
      <h2>運営者</h2>
      <p>
        Harmony Palette 運営<br/>
        1歳の娘の影響でハーモニーランド好きになった家族が、実際にハーモニーランドに行って得た情報を整理して公開しています。<br/>
        初めての方でも最大限ハーモニーランドを楽しめて、また行きたいと思ってもらえることが目標です♪<br/>
        推しは、ピアノちゃん❤月に複数回ハーモニーランドに行ってます☺
      </p>
