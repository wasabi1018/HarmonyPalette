...
function JournalSection({
  ...
  return (
    <section className="mx-auto max-w-[1200px] px-4 pb-4 pt-12 sm:px-6 lg:px-8">
      <Link
        href="/guide"
        className="group flex items-center gap-4 rounded-[22px] border border-[#f4dfae] bg-[#fffaf0] p-4 shadow-soft transition-all hover:-translate-y-0.5 hover:border-[#e8c979] hover:shadow-card sm:p-5"
      >
        ...
        <ArrowRight size={18} className="shrink-0 text-pink transition-transform group-hover:translate-x-1" aria-hidden="true" />
      </Link>
