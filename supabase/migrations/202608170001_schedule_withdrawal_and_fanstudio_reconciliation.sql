  ...
  where old_item.publication_status = 'published'
    ...
    and exists (
      ...
      where new_item.import_run_id = target_run
        ...
        and (
          new_item.external_key = old_item.external_key
          or (
            new_item.source_id = 'harmonyland-funstudio'
            and new_item.event_date = old_item.event_date
            and new_item.start_time = old_item.start_time
            and new_item.location = old_item.location
          )
        )
    );
